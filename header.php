	...
	<div class="container">
		<div class="d-flex justify-content-between">
			<div class="dl-header__logo-wrap">
				...
				<p class="dl-header__logo-description">
					Комплекс послуг авто в Івано-Франківську
				</p>
			...
			<div class="dl-header__soc-wrap">
				...
				<div class="dl-header__icons-wrap">
					<span class="dl-ico dl-ico--tg dl-header__icon"></span>
					<span class="dl-ico dl-ico--vb dl-header__icon"></span>
				</div>
			</div>
			...
			<div class="dl-header__phone-wrap">
				...
				<div class="dl-header__phones-wrap">
					<?php //if(!empty($phone_1)) : ?>
						<a class="dl-header__phone" href="tel:380667377273<?php// echo preg_replace('/\s+/', '', esc_html($phone)); ?>">
							<?php //echo esc_html($phone_1); ?>+38 (066) 737-72-73
						</a>
					<?php //endif; ?>
					<?php //if(!empty($phone_2)) : ?>
						<a class="dl-header__phone" href="tel:380980350345<?php //echo preg_replace('/\s+/', '', esc_html($phone)); ?>">
