			...
			<div class="dl-header__inner">
				<div class="dl-header__logo-wrap">
					...
					<p class="dl-textline dl-textline--s dl-header__logo-description text-left">
						Комплекс автопослуг в<br>
						Івано-Франківську
					</p>
				</div>

				<div class="dl-header__btn-wrap">
					<p class="dl-textline dl-textline--s d-none d-md-block">Безкоштовна консультація</p>
					<?php if(!empty($phone1)) : ?>
					<p class="dl-textline dl-textline--s d-md-none d-block">
